...
| **Artwork** | ![Artwork de Silvally Grifo](../../.gitbook/assets/Griffin.png)       |
| ----------: | --------------------------------------------------------------------- |
|  **Sprite** | ![Sprite de Silvally Grifo](../../.gitbook/assets/Griffin-sprite.png) |
...
{% hint style="info" %}
Esta skin, al igual que la versión original, puede cambiar de forma usando sus Discos.
{% endhint %}

![Formas de Silvally Grifo](../../.gitbook/assets/Griffin-formas.png)
